...
public class VetController {
	...
	@Transactional
	@DeleteMapping("/delete/timeslot/{vetId}/{date}/{time}")
	@Operation(summary = "To delete the time slot of that vet on that date")
	public ResponseEntity<String> deleteTimeSlot(@PathVariable (value = "vetId") Long vetId, @PathVariable (value = "date") String date,
			@PathVariable (value = "time")String time) {
		System.out.println("bjfgjv,");
